...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		levelDifficulty.setFormat(Paths.font('pixel.otf'), 32);
		...
		perSongOffset.setFormat(Paths.font("pixel.otf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
