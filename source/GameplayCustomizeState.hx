...
class GameplayCustomizeState extends MusicBeatState
{
    ...
    public override function create() {
		...
		DiscordClient.changePresence("Configuring Options", null);
		#end
		...
		text.setFormat(Paths.font("pixel.otf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
