...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		 ...
		 */
		 ...
		 DiscordClient.changePresence("In the Training Menu", null);
		 #end
		...
		scoreText.setFormat(Paths.font("pixel.otf"), 32, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function changeDiff(change:Int = 0)
	{
		...
		{
			case 0:
				diffText.text = "SLEEPTROT";
			case 1:
				diffText.text = 'CONTENDER';
			case 2:
