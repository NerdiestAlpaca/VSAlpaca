...
class PlayState extends MusicBeatState
{
    ...
    {	
        					...
        					var fire:FlxSprite = new FlxSprite(-300, -700);
	...
	case 'tanklands':
    {
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Champion" : storyDifficulty == 1 ? "Contender" : "Sleeptrot") + (Main.watermarks ? " - KE " + MainMenuState.kadeEngineVer : ""), 16);
	...
	override public function update(elapsed:Float)
	{
		...
		if (health <= 0)
		{
			...
			DiscordClient.changePresence("DEFEATED -- " + SONG.song + " (" + storyDifficultyText + ") " + Ratings.GenerateLetterRank(accuracy),"\nAcc: " + HelperFunctions.truncateFloat(accuracy, 2) + "% | Score: " + songScore + " | Misses: " + misses  , iconRPC);
			#end
			...
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
					{
						...
						video.playMP4(Paths.video('EpilogueScene'), new StoryMenuState(), false, false, false);
				...
				else
				{
					...
					switch (curSong.toLowerCase())
					{
						case 'whimsy':
							var video:VideoHandlerMP4 = new VideoHandlerMP4();
							video.playMP4(Paths.video('CycloneCutscene'), new PlayState(), false, false, false);
						case 'cyclone':
							var video:VideoHandlerMP4 = new VideoHandlerMP4();
							video.playMP4(Paths.video('ShadowsCutscene'), new PlayState(), false, false, false);
						case 'shadows':
							var video:VideoHandlerMP4 = new VideoHandlerMP4();
							video.playMP4(Paths.video('AbsolutionCutscene'), new PlayState(), false, false, false);
						default:
